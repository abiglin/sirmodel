...
canvas1 = Canvas(top)
canvas1.create_text(200,100,text="System:"+"\n"+"  dS / dt = -(α / N) * S * I"+"\n"+"  dI / dt = (α / N) * S * I - β * I"+"\n"+"  dR / dt = β * I"+"\n"+"\n"+"  α: infection by contact"+"\n"+"  β: death by infection"+"\n"+"  N: total population (=S+I+R)",font=labelFont,activefill='red',justify=LEFT)
#canvas1.create_text(200,185,text="Initial Conditions, Parameters",font=labelFont,activefill='red',justify=LEFT)
canvas1.pack()

infection_label.place(x=55,y=285)
removed_label.place(x=110,y=285)
infection_entry.place(x=55,y=315)
removed_entry.place(x=110,y=315)
enter_button.place(x=55,y=440)
Extension_button.place(x=55, y=490)
S0_label.place(x=55,y=205)
S0_entry.place(x=55,y=235)
I0_label.place(x=110,y=205)
I0_entry.place(x=110,y=235)
R0_label.place(x=165,y=205)
R0_entry.place(x=165,y=235)
Start_label.place(x=55,y=360)
Start_entry.place(x=55,y=395)
Stop_label.place(x=115,y=360)
Stop_entry.place(x=115,y=395)    
Steps_label.place(x=175,y=360)
Steps_entry.place(x=175,y=395)
