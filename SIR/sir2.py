...
infection_label.place(x=5,y=95)
removed_label.place(x=60,y=95)
infection_entry.place(x=5,y=125)
removed_entry.place(x=60,y=125)
enter_button.place(x=5,y=250)
Extension_button.place(x=5, y=300)
S0_label.place(x=5,y=15)
S0_entry.place(x=5,y=45)
I0_label.place(x=60,y=15)
I0_entry.place(x=60,y=45)
R0_label.place(x=115,y=15)
R0_entry.place(x=115,y=45)
Start_label.place(x=5,y=170)
Start_entry.place(x=5,y=205)
Stop_label.place(x=65,y=170)
Stop_entry.place(x=65,y=205)    
Steps_label.place(x=125,y=170)
Steps_entry.place(x=125,y=205)

canvas1 = Canvas(top)
canvas1.create_text(10,350,text="System:"+"\n"+"  dS / dt = -(α / N) * S * I"+"\n"+"  dI / dt = (α / N) * S * I - β * I"+"\n"+"  dR / dt = β * I"+"\n"+"\n"+"  α: infection by contact"+"\n"+"  β: death by infection"+"\n"+"  N: total population (=S+I+R)",font=labelFont,activefill='red',justify=LEFT)
canvas1.create_text(10,400,text="Initial Conditions, Parameters:",font=labelFont,activefill='red',justify=LEFT)
canvas1.pack()
