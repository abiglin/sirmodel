...
infection_label.place(x=55,y=100)
removed_label.place(x=110,y=100)
infection_entry.place(x=55,y=130)
removed_entry.place(x=110,y=130)
enter_button.place(x=55,y=255)
Extension_button.place(x=55, y=305)
S0_label.place(x=55,y=20)
S0_entry.place(x=55,y=50)
I0_label.place(x=110,y=20)
I0_entry.place(x=110,y=50)
R0_label.place(x=165,y=20)
R0_entry.place(x=165,y=50)
Start_label.place(x=55,y=175)
Start_entry.place(x=55,y=210)
Stop_label.place(x=115,y=175)
Stop_entry.place(x=115,y=210)    
Steps_label.place(x=175,y=175)
Steps_entry.place(x=175,y=210)
