...
# canvas1 = Canvas(top)
# canvas1.create_text(200,80,text="System:"+"\n"+"  dS / dt = -(α / N) * S * I"+"\n"+"  dI / dt = (α / N) * S * I - β * I"+"\n"+"  dR / dt = β * I"+"\n"+"\n"+"  α: infection by contact"+"\n"+"  β: death by infection"+"\n"+"  N: total population (=S+I+R)",font=labelFont,activefill='red',justify=LEFT)
# canvas1.create_text(200,185,text="Initial Conditions, Parameters:",font=labelFont,activefill='red',justify=LEFT)
# canvas1.pack()

infection_label.place(x=5,y=295)
removed_label.place(x=60,y=295)
infection_entry.place(x=5,y=325)
removed_entry.place(x=60,y=325)
enter_button.place(x=5,y=450)
Extension_button.place(x=5, y=500)
S0_label.place(x=5,y=215)
S0_entry.place(x=5,y=245)
I0_label.place(x=60,y=215)
I0_entry.place(x=60,y=245)
R0_label.place(x=115,y=215)
R0_entry.place(x=115,y=245)
Start_label.place(x=5,y=370)
Start_entry.place(x=5,y=405)
Stop_label.place(x=65,y=370)
Stop_entry.place(x=65,y=405)    
Steps_label.place(x=125,y=370)
Steps_entry.place(x=125,y=405)
